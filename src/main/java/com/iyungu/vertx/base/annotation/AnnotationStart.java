package com.iyungu.vertx.base.annotation;

import com.iyungu.vertx.base.annotation.bean.ExecutorBean;
...
public class AnnotationStart {
    ...
    public AnnotationStart(Vertx vertx, Router mainRouter) throws InstantiationException, IllegalAccessException {
        map = AnnoManageUtil.getRequestMappingMethod("com.iyungu.vertx.main.handler");
        this.vertx = vertx;
